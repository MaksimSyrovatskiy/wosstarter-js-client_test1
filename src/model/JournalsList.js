...
class JournalsList {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new JournalsList();

            if (data.hasOwnProperty('metadata')) {
                obj['metadata'] = Metadata.constructFromObject(data['metadata']);
            }
            if (data.hasOwnProperty('hits')) {
                obj['hits'] = ApiClient.convertToType(data['hits'], [Journal]);
            }
        }
        return obj;
    }
 ...
 */
JournalsList.prototype['metadata'] = undefined;

/**
 * @member {Array.<module:model/Journal>} hits
 */
JournalsList.prototype['hits'] = undefined;
