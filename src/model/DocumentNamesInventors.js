...
/**
 * The DocumentNamesInventors model module.
 * @module model/DocumentNamesInventors
 * @version 1.0.0
 */
class DocumentNamesInventors {
    /**
     * Constructs a new <code>DocumentNamesInventors</code>.
     * @alias module:model/DocumentNamesInventors
     */
    constructor() { 
        
        DocumentNamesInventors.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DocumentNamesInventors</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DocumentNamesInventors} obj Optional instance to populate.
     * @return {module:model/DocumentNamesInventors} The populated <code>DocumentNamesInventors</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DocumentNamesInventors();
 ...
 */
DocumentNamesInventors.prototype['displayName'] = undefined;
...
export default DocumentNamesInventors;
