...
/**
 * The DocumentSourcePages model module.
 * @module model/DocumentSourcePages
 * @version 1.0.0
 */
class DocumentSourcePages {
    /**
     * Constructs a new <code>DocumentSourcePages</code>.
     * @alias module:model/DocumentSourcePages
     */
    constructor() { 
        
        DocumentSourcePages.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DocumentSourcePages</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DocumentSourcePages} obj Optional instance to populate.
     * @return {module:model/DocumentSourcePages} The populated <code>DocumentSourcePages</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DocumentSourcePages();
 ...
 * @member {String} range
 */
DocumentSourcePages.prototype['range'] = undefined;

/**
 * @member {String} begin
 */
DocumentSourcePages.prototype['begin'] = undefined;

/**
 * @member {String} end
 */
DocumentSourcePages.prototype['end'] = undefined;

/**
 * @member {Number} count
 */
DocumentSourcePages.prototype['count'] = undefined;
...
export default DocumentSourcePages;
