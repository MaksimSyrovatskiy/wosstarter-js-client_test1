...
import JournalLinks from './JournalLinks';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('links')) {
                obj['links'] = ApiClient.convertToType(data['links'], [JournalLinks]);
            }
        }
        return obj;
    }
 ...
 */
Journal.prototype['jcrTitle'] = undefined;

/**
 * @member {String} isoTitle
 */
Journal.prototype['isoTitle'] = undefined;

/**
 * @member {String} issn
 */
Journal.prototype['issn'] = undefined;

/**
 * @member {Array.<String>} previousIssn
 */
Journal.prototype['previousIssn'] = undefined;

/**
 * @member {String} eIssn
 */
Journal.prototype['eIssn'] = undefined;

/**
 * @member {Array.<module:model/JournalLinks>} links
 */
Journal.prototype['links'] = undefined;
