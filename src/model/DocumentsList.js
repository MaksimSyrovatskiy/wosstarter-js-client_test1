...
class DocumentsList {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DocumentsList();

            if (data.hasOwnProperty('metadata')) {
                obj['metadata'] = Metadata.constructFromObject(data['metadata']);
            }
            if (data.hasOwnProperty('hits')) {
                obj['hits'] = ApiClient.convertToType(data['hits'], [Document]);
            }
        }
        return obj;
    }
 ...
 */
DocumentsList.prototype['metadata'] = undefined;

/**
 * @member {Array.<module:model/Document>} hits
 */
DocumentsList.prototype['hits'] = undefined;
