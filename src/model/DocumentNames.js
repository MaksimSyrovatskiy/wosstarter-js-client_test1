...
import DocumentNamesAuthors from './DocumentNamesAuthors';
import DocumentNamesInventors from './DocumentNamesInventors';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('authors')) {
                obj['authors'] = ApiClient.convertToType(data['authors'], [DocumentNamesAuthors]);
            }
            if (data.hasOwnProperty('inventors')) {
                obj['inventors'] = ApiClient.convertToType(data['inventors'], [DocumentNamesInventors]);
            }
            if (data.hasOwnProperty('bookCorp')) {
                obj['bookCorp'] = ApiClient.convertToType(data['bookCorp'], [DocumentNamesInventors]);
            }
            if (data.hasOwnProperty('bookEditors')) {
                obj['bookEditors'] = ApiClient.convertToType(data['bookEditors'], [DocumentNamesInventors]);
            }
            if (data.hasOwnProperty('books')) {
                obj['books'] = ApiClient.convertToType(data['books'], [DocumentNamesInventors]);
            }
            if (data.hasOwnProperty('additionalAuthors')) {
                obj['additionalAuthors'] = ApiClient.convertToType(data['additionalAuthors'], [DocumentNamesInventors]);
            }
            if (data.hasOwnProperty('anonymous')) {
                obj['anonymous'] = ApiClient.convertToType(data['anonymous'], [DocumentNamesInventors]);
            }
            if (data.hasOwnProperty('assignees')) {
                obj['assignees'] = ApiClient.convertToType(data['assignees'], [DocumentNamesInventors]);
            }
            if (data.hasOwnProperty('corp')) {
                obj['corp'] = ApiClient.convertToType(data['corp'], [DocumentNamesInventors]);
            }
            if (data.hasOwnProperty('editors')) {
                obj['editors'] = ApiClient.convertToType(data['editors'], [DocumentNamesInventors]);
            }
            if (data.hasOwnProperty('investigators')) {
                obj['investigators'] = ApiClient.convertToType(data['investigators'], [DocumentNamesInventors]);
            }
            if (data.hasOwnProperty('sponsors')) {
                obj['sponsors'] = ApiClient.convertToType(data['sponsors'], [DocumentNamesInventors]);
            }
            if (data.hasOwnProperty('issuingOrganizations')) {
                obj['issuingOrganizations'] = ApiClient.convertToType(data['issuingOrganizations'], [DocumentNamesInventors]);
            }
        }
        return obj;
    }
...
/**
 * @member {Array.<module:model/DocumentNamesAuthors>} authors
 */
DocumentNames.prototype['authors'] = undefined;

/**
 * @member {Array.<module:model/DocumentNamesInventors>} inventors
 */
DocumentNames.prototype['inventors'] = undefined;

/**
 * @member {Array.<module:model/DocumentNamesInventors>} bookCorp
 */
DocumentNames.prototype['bookCorp'] = undefined;

/**
 * @member {Array.<module:model/DocumentNamesInventors>} bookEditors
 */
DocumentNames.prototype['bookEditors'] = undefined;

/**
 * @member {Array.<module:model/DocumentNamesInventors>} books
 */
DocumentNames.prototype['books'] = undefined;

/**
 * @member {Array.<module:model/DocumentNamesInventors>} additionalAuthors
 */
DocumentNames.prototype['additionalAuthors'] = undefined;

/**
 * @member {Array.<module:model/DocumentNamesInventors>} anonymous
 */
DocumentNames.prototype['anonymous'] = undefined;

/**
 * @member {Array.<module:model/DocumentNamesInventors>} assignees
 */
DocumentNames.prototype['assignees'] = undefined;

/**
 * @member {Array.<module:model/DocumentNamesInventors>} corp
 */
DocumentNames.prototype['corp'] = undefined;

/**
 * @member {Array.<module:model/DocumentNamesInventors>} editors
 */
DocumentNames.prototype['editors'] = undefined;

/**
 * @member {Array.<module:model/DocumentNamesInventors>} investigators
 */
DocumentNames.prototype['investigators'] = undefined;

/**
 * @member {Array.<module:model/DocumentNamesInventors>} sponsors
 */
DocumentNames.prototype['sponsors'] = undefined;

/**
 * @member {Array.<module:model/DocumentNamesInventors>} issuingOrganizations
 */
