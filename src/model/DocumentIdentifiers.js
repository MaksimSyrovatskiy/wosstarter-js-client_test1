...
/**
 * The DocumentIdentifiers model module.
 * @module model/DocumentIdentifiers
 * @version 1.0.0
 */
class DocumentIdentifiers {
    /**
     * Constructs a new <code>DocumentIdentifiers</code>.
     * @alias module:model/DocumentIdentifiers
     */
    constructor() { 
        
        DocumentIdentifiers.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DocumentIdentifiers</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DocumentIdentifiers} obj Optional instance to populate.
     * @return {module:model/DocumentIdentifiers} The populated <code>DocumentIdentifiers</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DocumentIdentifiers();
            ...
            if (data.hasOwnProperty('eisbn')) {
                obj['eisbn'] = ApiClient.convertToType(data['eisbn'], 'String');
            }
 ...
 * @member {String} doi
 */
DocumentIdentifiers.prototype['doi'] = undefined;

/**
 * @member {String} issn
 */
DocumentIdentifiers.prototype['issn'] = undefined;

/**
 * @member {String} eissn
 */
DocumentIdentifiers.prototype['eissn'] = undefined;

/**
 * @member {String} isbn
 */
DocumentIdentifiers.prototype['isbn'] = undefined;

/**
 * @member {String} eisbn
 */
DocumentIdentifiers.prototype['eisbn'] = undefined;

/**
 * @member {String} pmid
 */
DocumentIdentifiers.prototype['pmid'] = undefined;
...
export default DocumentIdentifiers;
