...
class DocumentLinks {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('citingArticles')) {
                obj['citingArticles'] = ApiClient.convertToType(data['citingArticles'], 'String');
            }
 ...
 */
DocumentLinks.prototype['record'] = undefined;

/**
 * @member {String} citingArticles
 */
DocumentLinks.prototype['citingArticles'] = undefined;

/**
 * @member {String} references
 */
DocumentLinks.prototype['references'] = undefined;

/**
 * @member {String} related
 */
DocumentLinks.prototype['related'] = undefined;
