...
/**
 * The JournalLinks model module.
 * @module model/JournalLinks
 * @version 1.0.0
 */
class JournalLinks {
    /**
     * Constructs a new <code>JournalLinks</code>.
     * @alias module:model/JournalLinks
     */
    constructor() { 
        
        JournalLinks.initialize(this);
    }
    ...
    /**
     * Constructs a <code>JournalLinks</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/JournalLinks} obj Optional instance to populate.
     * @return {module:model/JournalLinks} The populated <code>JournalLinks</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new JournalLinks();
 ...
 * @member {String} type
 */
JournalLinks.prototype['type'] = undefined;

/**
 * @member {String} url
 */
JournalLinks.prototype['url'] = undefined;
