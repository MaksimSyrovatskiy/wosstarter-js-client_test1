...
/**
 * The DocumentCitations model module.
 * @module model/DocumentCitations
 * @version 1.0.0
 */
class DocumentCitations {
    /**
     * Constructs a new <code>DocumentCitations</code>.
     * @alias module:model/DocumentCitations
     */
    constructor() { 
        
        DocumentCitations.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DocumentCitations</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DocumentCitations} obj Optional instance to populate.
     * @return {module:model/DocumentCitations} The populated <code>DocumentCitations</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DocumentCitations();
 ...
 * @member {String} db
 */
DocumentCitations.prototype['db'] = undefined;

/**
 * @member {Number} count
 */
DocumentCitations.prototype['count'] = undefined;
