...
/**
 * The DocumentNamesAuthors model module.
 * @module model/DocumentNamesAuthors
 * @version 1.0.0
 */
class DocumentNamesAuthors {
    /**
     * Constructs a new <code>DocumentNamesAuthors</code>.
     * @alias module:model/DocumentNamesAuthors
     */
    constructor() { 
        
        DocumentNamesAuthors.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DocumentNamesAuthors</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DocumentNamesAuthors} obj Optional instance to populate.
     * @return {module:model/DocumentNamesAuthors} The populated <code>DocumentNamesAuthors</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DocumentNamesAuthors();

            if (data.hasOwnProperty('displayName')) {
                obj['displayName'] = ApiClient.convertToType(data['displayName'], 'String');
            }
            if (data.hasOwnProperty('wosStandard')) {
                obj['wosStandard'] = ApiClient.convertToType(data['wosStandard'], 'String');
            }
            if (data.hasOwnProperty('researcherId')) {
                obj['researcherId'] = ApiClient.convertToType(data['researcherId'], 'String');
            }
        }
        return obj;
    }
 ...
 */
DocumentNamesAuthors.prototype['displayName'] = undefined;

/**
 * @member {String} wosStandard
 */
DocumentNamesAuthors.prototype['wosStandard'] = undefined;

/**
 * @member {String} researcherId
 */
DocumentNamesAuthors.prototype['researcherId'] = undefined;
...
export default DocumentNamesAuthors;
