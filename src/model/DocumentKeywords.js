...
/**
 * The DocumentKeywords model module.
 * @module model/DocumentKeywords
 * @version 1.0.0
 */
class DocumentKeywords {
    /**
     * Constructs a new <code>DocumentKeywords</code>.
     * @alias module:model/DocumentKeywords
     */
    constructor() { 
        
        DocumentKeywords.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DocumentKeywords</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DocumentKeywords} obj Optional instance to populate.
     * @return {module:model/DocumentKeywords} The populated <code>DocumentKeywords</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DocumentKeywords();

            if (data.hasOwnProperty('authorKeywords')) {
                obj['authorKeywords'] = ApiClient.convertToType(data['authorKeywords'], ['String']);
            }
        }
        return obj;
    }
...
/**
 * @member {Array.<String>} authorKeywords
 */
DocumentKeywords.prototype['authorKeywords'] = undefined;
...
export default DocumentKeywords;
