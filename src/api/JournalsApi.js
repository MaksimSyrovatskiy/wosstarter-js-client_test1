...
export default class JournalsApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the journalsUidGet operation.
     * @callback module:api/JournalsApi~journalsUidGetCallback
     * @param {String} error Error message, if any.
     * @param {module:model/Journal} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */

    /**
     * @param {String} uid 
     * @param {module:api/JournalsApi~journalsUidGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/Journal}
     */
    journalsUidGet(uid, callback) {
      let postBody = null;
      // verify the required parameter 'uid' is set
      if (uid === undefined || uid === null) {
        throw new Error("Missing the required parameter 'uid' when calling journalsUidGet");
      }
