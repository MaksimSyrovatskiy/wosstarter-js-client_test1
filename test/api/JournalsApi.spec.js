...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClarivateWosStarterJsClient.JournalsApi();
  });
  ...
  describe('JournalsApi', function() {
    describe('journalsGet', function() {
      it('should call journalsGet successfully', function(done) {
        //uncomment below and update the code to test journalsGet
        //instance.journalsGet(function(error) {
    ...
    describe('journalsUidGet', function() {
      it('should call journalsUidGet successfully', function(done) {
        //uncomment below and update the code to test journalsUidGet
        //instance.journalsUidGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
