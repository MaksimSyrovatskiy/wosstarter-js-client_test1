...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClarivateWosStarterJsClient.DocumentsApi();
  });
  ...
  describe('DocumentsApi', function() {
    ...
    describe('documentsUidGet', function() {
      it('should call documentsUidGet successfully', function(done) {
        //uncomment below and update the code to test documentsUidGet
        //instance.documentsUidGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
