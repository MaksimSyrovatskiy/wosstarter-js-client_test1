...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClarivateWosStarterJsClient.DocumentKeywords();
  });
  ...
  describe('DocumentKeywords', function() {
    it('should create an instance of DocumentKeywords', function() {
      // uncomment below and update the code to test DocumentKeywords
      //var instance = new ClarivateWosStarterJsClient.DocumentKeywords();
      //expect(instance).to.be.a(ClarivateWosStarterJsClient.DocumentKeywords);
    });

    it('should have the property authorKeywords (base name: "authorKeywords")', function() {
      // uncomment below and update the code to test the property authorKeywords
      //var instance = new ClarivateWosStarterJsClient.DocumentKeywords();
