...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClarivateWosStarterJsClient.DocumentsList();
  });
  ...
  describe('DocumentsList', function() {
    it('should create an instance of DocumentsList', function() {
      ...
      //var instance = new ClarivateWosStarterJsClient.DocumentsList();
      //expect(instance).to.be.a(ClarivateWosStarterJsClient.DocumentsList);
    });
