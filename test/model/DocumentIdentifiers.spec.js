...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClarivateWosStarterJsClient.DocumentIdentifiers();
  });
  ...
  describe('DocumentIdentifiers', function() {
    it('should create an instance of DocumentIdentifiers', function() {
      // uncomment below and update the code to test DocumentIdentifiers
      //var instance = new ClarivateWosStarterJsClient.DocumentIdentifiers();
      //expect(instance).to.be.a(ClarivateWosStarterJsClient.DocumentIdentifiers);
    });
    ...
    it('should have the property eisbn (base name: "eisbn")', function() {
      // uncomment below and update the code to test the property eisbn
      //var instance = new ClarivateWosStarterJsClient.DocumentIdentifiers();
      //expect(instance).to.be();
    });
