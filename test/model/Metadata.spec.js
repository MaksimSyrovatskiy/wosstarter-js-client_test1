...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClarivateWosStarterJsClient.Metadata();
  });
  ...
  describe('Metadata', function() {
    it('should create an instance of Metadata', function() {
      ...
      //var instance = new ClarivateWosStarterJsClient.Metadata();
      //expect(instance).to.be.a(ClarivateWosStarterJsClient.Metadata);
    });
