...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClarivateWosStarterJsClient.DocumentSourcePages();
  });
  ...
  describe('DocumentSourcePages', function() {
    it('should create an instance of DocumentSourcePages', function() {
      // uncomment below and update the code to test DocumentSourcePages
      //var instance = new ClarivateWosStarterJsClient.DocumentSourcePages();
      //expect(instance).to.be.a(ClarivateWosStarterJsClient.DocumentSourcePages);
    });
