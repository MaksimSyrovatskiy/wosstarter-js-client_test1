...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClarivateWosStarterJsClient.DocumentLinks();
  });
  ...
  describe('DocumentLinks', function() {
    it('should create an instance of DocumentLinks', function() {
      ...
      //var instance = new ClarivateWosStarterJsClient.DocumentLinks();
      //expect(instance).to.be.a(ClarivateWosStarterJsClient.DocumentLinks);
    });
    ...
    it('should have the property citingArticles (base name: "citingArticles")', function() {
      // uncomment below and update the code to test the property citingArticles
      //var instance = new ClarivateWosStarterJsClient.DocumentLinks();
      //expect(instance).to.be();
    });
