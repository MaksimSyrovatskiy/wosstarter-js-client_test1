...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClarivateWosStarterJsClient.DocumentNamesAuthors();
  });
  ...
  describe('DocumentNamesAuthors', function() {
    it('should create an instance of DocumentNamesAuthors', function() {
      // uncomment below and update the code to test DocumentNamesAuthors
      //var instance = new ClarivateWosStarterJsClient.DocumentNamesAuthors();
      //expect(instance).to.be.a(ClarivateWosStarterJsClient.DocumentNamesAuthors);
    });
    ...
    it('should have the property wosStandard (base name: "wosStandard")', function() {
      // uncomment below and update the code to test the property wosStandard
      //var instance = new ClarivateWosStarterJsClient.DocumentNamesAuthors();
      //expect(instance).to.be();
    });

    it('should have the property researcherId (base name: "researcherId")', function() {
      // uncomment below and update the code to test the property researcherId
      //var instance = new ClarivateWosStarterJsClient.DocumentNamesAuthors();
      //expect(instance).to.be();
    });
