...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClarivateWosStarterJsClient.JournalLinks();
  });
  ...
  describe('JournalLinks', function() {
    it('should create an instance of JournalLinks', function() {
      // uncomment below and update the code to test JournalLinks
      //var instance = new ClarivateWosStarterJsClient.JournalLinks();
      //expect(instance).to.be.a(ClarivateWosStarterJsClient.JournalLinks);
    });
