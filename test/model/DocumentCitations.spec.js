...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClarivateWosStarterJsClient.DocumentCitations();
  });
  ...
  describe('DocumentCitations', function() {
    it('should create an instance of DocumentCitations', function() {
      // uncomment below and update the code to test DocumentCitations
      //var instance = new ClarivateWosStarterJsClient.DocumentCitations();
      //expect(instance).to.be.a(ClarivateWosStarterJsClient.DocumentCitations);
    });
