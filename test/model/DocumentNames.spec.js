...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    factory(root.expect, root.ClarivateWosStarterJsClient);
  }
}(this, function(expect, ClarivateWosStarterJsClient) {
  'use strict';

  var instance;

  beforeEach(function() {
    instance = new ClarivateWosStarterJsClient.DocumentNames();
  });
  ...
  describe('DocumentNames', function() {
    it('should create an instance of DocumentNames', function() {
      // uncomment below and update the code to test DocumentNames
      //var instance = new ClarivateWosStarterJsClient.DocumentNames();
      //expect(instance).to.be.a(ClarivateWosStarterJsClient.DocumentNames);
    });
    ...
    it('should have the property inventors (base name: "inventors")', function() {
      // uncomment below and update the code to test the property inventors
      //var instance = new ClarivateWosStarterJsClient.DocumentNames();
      //expect(instance).to.be();
    });

    it('should have the property bookCorp (base name: "bookCorp")', function() {
      // uncomment below and update the code to test the property bookCorp
      //var instance = new ClarivateWosStarterJsClient.DocumentNames();
      //expect(instance).to.be();
    });

    it('should have the property bookEditors (base name: "bookEditors")', function() {
      // uncomment below and update the code to test the property bookEditors
      //var instance = new ClarivateWosStarterJsClient.DocumentNames();
      //expect(instance).to.be();
    });
    ...
    it('should have the property additionalAuthors (base name: "additionalAuthors")', function() {
      // uncomment below and update the code to test the property additionalAuthors
      //var instance = new ClarivateWosStarterJsClient.DocumentNames();
      //expect(instance).to.be();
    });
    ...
    it('should have the property corp (base name: "corp")', function() {
      // uncomment below and update the code to test the property corp
      //var instance = new ClarivateWosStarterJsClient.DocumentNames();
      //expect(instance).to.be();
    });
    ...
    it('should have the property investigators (base name: "investigators")', function() {
      // uncomment below and update the code to test the property investigators
      //var instance = new ClarivateWosStarterJsClient.DocumentNames();
      //expect(instance).to.be();
    });
    ...
    it('should have the property issuingOrganizations (base name: "issuingOrganizations")', function() {
      // uncomment below and update the code to test the property issuingOrganizations
      //var instance = new ClarivateWosStarterJsClient.DocumentNames();
      //expect(instance).to.be();
    });
