...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClarivateWosStarterJsClient.DocumentNamesInventors();
  });
  ...
  describe('DocumentNamesInventors', function() {
    it('should create an instance of DocumentNamesInventors', function() {
      // uncomment below and update the code to test DocumentNamesInventors
      //var instance = new ClarivateWosStarterJsClient.DocumentNamesInventors();
      //expect(instance).to.be.a(ClarivateWosStarterJsClient.DocumentNamesInventors);
    });
