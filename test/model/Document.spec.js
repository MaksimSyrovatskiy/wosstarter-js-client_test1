...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClarivateWosStarterJsClient.Document();
  });
  ...
  describe('Document', function() {
    it('should create an instance of Document', function() {
      ...
      //var instance = new ClarivateWosStarterJsClient.Document();
      //expect(instance).to.be.a(ClarivateWosStarterJsClient.Document);
    });
