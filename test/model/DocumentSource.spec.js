...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClarivateWosStarterJsClient.DocumentSource();
  });
  ...
  describe('DocumentSource', function() {
    it('should create an instance of DocumentSource', function() {
      ...
      //var instance = new ClarivateWosStarterJsClient.DocumentSource();
      //expect(instance).to.be.a(ClarivateWosStarterJsClient.DocumentSource);
    });

    it('should have the property sourceTitle (base name: "sourceTitle")', function() {
      // uncomment below and update the code to test the property sourceTitle
      //var instance = new ClarivateWosStarterJsClient.DocumentSource();
      //expect(instance).to.be();
    });

    it('should have the property publishYear (base name: "publishYear")', function() {
      // uncomment below and update the code to test the property publishYear
      //var instance = new ClarivateWosStarterJsClient.DocumentSource();
      //expect(instance).to.be();
    });

    it('should have the property publishMonth (base name: "publishMonth")', function() {
      // uncomment below and update the code to test the property publishMonth
      //var instance = new ClarivateWosStarterJsClient.DocumentSource();
      //expect(instance).to.be();
    });
    ...
    it('should have the property specialIssue (base name: "specialIssue")', function() {
      // uncomment below and update the code to test the property specialIssue
      //var instance = new ClarivateWosStarterJsClient.DocumentSource();
      //expect(instance).to.be();
    });
