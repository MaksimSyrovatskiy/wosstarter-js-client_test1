...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClarivateWosStarterJsClient.JournalsList();
  });
  ...
  describe('JournalsList', function() {
    it('should create an instance of JournalsList', function() {
      ...
      //var instance = new ClarivateWosStarterJsClient.JournalsList();
      //expect(instance).to.be.a(ClarivateWosStarterJsClient.JournalsList);
    });
